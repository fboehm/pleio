...
calc_profile_lods <- function(log10det_rss){
  ...
  p1 <- calc_profile_lod(log10det_rss_mins = log10det_rss_row_mins, log10det_rss0 = log10det_rss0, n_mouse = dim(probs$probs$`19`)[1])
  p2 <- calc_profile_lod(log10det_rss_mins = log10det_rss_col_mins, log10det_rss0 = log10det_rss0, n_mouse = dim(probs$probs$`19`)[1])
  return(list(p1, p2))
}
